...
const isValidPhoneNumber = (phone) => {
    phone = phone === null || phone === void 0 ? void 0 : phone.replace(/\D/g, "");
    if (!phone)
        return false;
    if (phone.length !== 13)
        return false;
    ...
    if (new Set(phone).size === 1)
        return false;
    if (BRAZIL_VALID_PHONE_DDD.indexOf(parseInt(phone.substring(2, 4))) === -1)
        return false;
    return true;
};
const AuthRegisterValidator = zod_1.z.object({
...
exports.default = AuthRegisterValidator;
//# sourceMappingURL=auth-register.validator.js.map
...
import * as StripeCharges from "./jsons/stripe/charges.json" with { type: "json" };
import * as StripeCustomers from "./jsons/stripe/customers.json" with { type: "json" };
import * as StripeInvoices from "./jsons/stripe/invoices.json" with { type: "json" };
import * as StripeCheckouts from "./jsons/stripe/checkouts.json" with { type: "json" };
import * as StripeBillingPortals from "./jsons/stripe/billing-portals.json" with { type: "json" };
import * as StripePayments from "./jsons/stripe/payments.json" with { type: "json" };
...
export default class StripeRepository implements StripeRepositoryPort {
    constructor(
        private charges = StripeCharges.default,
        private customers = StripeCustomers.default,
        private invoices = StripeInvoices.default,
        private checkouts = StripeCheckouts.default,
        private billingPortals = StripeBillingPortals.default,
        private payments = StripePayments.default,
